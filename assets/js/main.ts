...
function subMenu() {
    ...
    if (separator.length) {
        ...
        subMenu.on('animationend', function (e) {
            ...
            if ((e.originalEvent as AnimationEvent).animationName == 'zoomOut') {
                subMenu.hide();
            }
        });
    }
...
declare var gh_white_logo: string | undefined
declare var gh_white_icon: string | undefined
...
function gallery() {
    'use strict';
    var images = document.querySelectorAll<HTMLImageElement>('.kg-gallery-image img');
    images.forEach(function (image) {
        var container = image.closest('.kg-gallery-image') as HTMLElement;
...
declare var gh_search_key: string | undefined
declare var gh_search_migration: string | undefined
declare var gh_search_content: boolean | undefined
...
function search() {
    ...
    var index: elasticlunr.Index<SearchDocument> | null = null;
    ...
    searchInput.on('keyup', function (e) {
        var result = index.search((e.target as HTMLInputElement).value, { expand: true });
        var output = '';

        result.forEach(function (post) {
            const doc = index.documentStore.getDoc(post.ref);
            output +=
